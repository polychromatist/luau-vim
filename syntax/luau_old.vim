...
" typedef
" typeof
syn region luauDynTypeDef matchgroup=luauTypeDelimiter transparent start=/\(\<type\s\+\w\+\s*=\s\{-}\)\@<=typeof\ze\s*[(]/ end="[)]"me=e-1 contains=ALLBUT,luaBraceError,luaBlock,luaLoopBlock,luaTodo,luaSpecial,luaStatement,luaConstant,luaIfThen,luaElseifThen,luaElse,luaThenEnd,luaIn,luaTypeOpError,luaFunc,robloxFunc,luauTypeDecl,luauDynTypeDef,luauStatement,luauTypeDef,luauType,luaFunctionBlock,luaInvocationWord,luaBlock,luauOperator
