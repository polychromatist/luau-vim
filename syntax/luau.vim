...
syn region luaDotInvocation contained transparent matchgroup=luaDotFCall start="\." end="("me=e-1 contains=luaWord
" function ... end
...
" Strings
syn match luaWord transparent contained /\<[a-zA-Z][a-zA-Z[:digit:]_]\=\>/
